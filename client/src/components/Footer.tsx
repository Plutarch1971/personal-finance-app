...
export default function Footer() {
  return (
    ...
    <div className="container-fluid d-flex flex-wrap justify-content-between px-4">
      ...
      {/* <div className="p-4"> */}
      <div className="p-2 d-flex flex-wrap text-white">
        ...
        <p className="ms-1">Email: smartbooksfinanceapp@gmail.com</p>
      </div>
    </div>
    // </div>
  );
