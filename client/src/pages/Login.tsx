  ...
  return (
    <div className="landing-page">
      ...
      <div className="login-header mt-4">
        ...
        <h3 className="text-warning display-5 fw-bold mb-0 login-title">
          SmartBooksFinance
        </h3>
      </div>
      ...
      <div className="landing-grid">
        ...
        <div className="left-panel">
          <div className="text-white">
            ...
            <ul>
              <li>
                <p>Monitor your Finances</p>
              </li>
              <li>
                <p>Track your expense, income and investment</p>
              </li>
              <li>
                <p>Upload receipts using file or camera</p>
              </li>
              <li>
                <p>Auto generate budget or create your own</p>
              </li>
              <li>
                <p>View reports</p>
              </li>
              <li>
                <p>
                  Understand how your money moves with visual and time-based
                  insights.
                </p>
              </li>
              <li>
                <p>
                  Build better money habits with a clear view of your daily
                  spending
                </p>
              </li>
            </ul>
        ...
        <div className="center-panel">
          <div className="dashboard-grid">
            ...
            <div className="dashboard-card">
              ...
              <div className="image-wrapper">
                <img
                  src="/expense-barchart.webp"
                  alt="expenses"
                  className="feature-image"
                />
              </div>
              <p>
                Build better money habits with a clear view of your
                spending.{" "}
              </p>
            </div>
            ...
            <div className="dashboard-card">
              <h5 className="text-primary fw-bold text-center">
                {" "}
                View expenses by percentage
              </h5>
              <div className="image-wrapper">
                <img
                  src="/expense-piechart.webp"
        ...
        <div className="right-panel text-white">
          ...
          <Link to="/forgot-password" className="text-warning text-center mt-4">
            Forgot Password?
          </Link>
