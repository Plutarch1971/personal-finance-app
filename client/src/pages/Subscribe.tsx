...
const plans: Plan[] = [
  ...
  },
  {
    ...
    period: "/ year",
    description:
      "Full access, billed yearly. Save 17% compared with monthly billing.",
      ...
      <div className="w-100" style={{ maxWidth: "720px" }}>
        ...
        <div className="text-center mb-4">
          ...
          <p className="text-white">
            Choose a subscription below to continue using
        ...
        <div className="d-flex align-items-center justify-content-center mt-3">
          ...
          <button className="btn btn-primary bg-danger" onClick={logout}>
            Logout
          </button>
        </div>
      </div>
