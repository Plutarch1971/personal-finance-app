    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                ...
                return [4 /*yield*/, userService.resetPassword(token, password)];
            case 1:
                _a.sent(); //cast { token } to string
                return [2 /*return*/, res.status(200).json({
            ...
            case 2:
                ...
                if (error_2 instanceof Error &&
                    error_2.message === 'INVALID_TOKEN') {
                    return [2 /*return*/, res.status(400).json({
                            message: 'Ivalid token'
                        })];
                }
                if (error_2 instanceof Error &&
                    error_2.message === 'TOKEN_EXPIRED') {
                    return [2 /*return*/, res.status(400).json({
